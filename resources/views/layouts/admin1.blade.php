        ...
        <div id="layoutSidenav_nav">
            <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        <a class="nav-link {{ request()->is('dashboard/index') || request()->is('dashboard/index/*') ? 'active' : '' }} "
                        ...
                        @if (Auth::user()->role == 'admin' || Auth::user()->role == 'user')
                            @if (Permission::check('cargo-index'))
                                <a class="nav-link {{ request()->is('dashboard/cargo/*') ? 'active' : '' }} " href="{{ route('cargo.index') }}">
                            ...
                            @if (Permission::check('sender-index'))
                                <a class="nav-link {{ request()->is('dashboard/customer/*') ? 'active' : '' }} " href="{{ route('customer.index') }}">
                            ...
                            @if (Permission::check('receiver-index'))
                                <a class="nav-link {{ request()->is('dashboard/receiver/*') ? 'active' : '' }} " href="{{ route('receiver.index') }}">
                                    <div class="sb-nav-link-icon"><i class="fas fa-arrow-right"></i></div>
                                    Alıcılar
                                </a>
                            @endif
                        ...
                        @if (Permission::check('user-index') || Auth::user()->role == 'root')
                            ...
                            <a class="nav-link {{ request()->is('dashboard/user/*') ? 'active' : '' }} " href="{{ route('user.index') }}">
                        ...
                        @if (Permission::check('cargo-status-index'))
                            <a class="nav-link {{ request()->is('dashboard/status/cargo*') ? 'active' : '' }} " href="{{ route('status.cargo.index') }}">
                                <div class="sb-nav-link-icon"><i class="fas fa-hashtag"></i></div>
                                Kargo Status Ayarları
                            </a>
                        @endif

                        
                        @if (Permission::check('sms-settings-index'))
                            <a class="nav-link {{ request()->is('dashboard/sms/*') ? 'active' : '' }} " href="{{ route('sms.index') }}">
                        ...
                        @if (Auth::user()->role == 'root')
                            <a class="nav-link  {{ request()->is('dashboard/company/*') ? 'active' : '' }} " href="{{ route('company.index') }}">
                                <div class="sb-nav-link-icon"><i class="fas fa-list"></i></div>
                                Şirketler
                            </a>

                            <a class="nav-link {{ request()->is('dashboard/page/*') ? 'active' : '' }} " href="{{ route('page.index') }}">
                                <div class="sb-nav-link-icon"><i class="fas fa-list"></i></div>
                                Sayfalar
                            </a>
                        @endif
						...
						<li class="nav-item" data-toggle="tooltip" data-placement="right" title="general settings">
							<a class="nav-link nav-link-collapse collapsed" data-toggle="collapse" href="#settings">
							  ...
							  <span class="nav-link-text ml-1"> Genel Ayarlar</span>
							</a>
							<ul class="sidenav-second-level collapse" id="settings">
							  <li class="nav-link">
								<a href="navbar.html" style="color:white">Fırma Ayarları</a>
							  </li>
							  <li class="nav-link ">
								<a href="cards.html" style="color:white">Header</a>
							  </li>
							  <li class="nav-link ">
								<a href="cards.html" style="color:white">Hakkında</a>
							  </li>
							</ul>
						  </li>
						  @endif
